Download URL: https://sourceforge.net/projects/lovebit/files/Lovebit/lovebit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LBT fee schedule (users still pay 0.01 LBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #lovebit00 - #lovebit99
