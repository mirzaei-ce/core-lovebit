Lovebit Core version 0.9.4 is now available from:

  https://lovebit.org/bin/0.9.4/
...
this update is incompatible with the Lovebit system and could lead to consensus
forks.

Lovebit Core released binaries from https://lovebit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lovebit/+archive/ubuntu/lovebit
- A third-party or self-compiled Lovebit Core

upgrade to Lovebit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
