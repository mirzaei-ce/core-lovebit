Lovebit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lovebit/files/Lovebit/lovebit-0.5.4/
...
http://gitorious.org/lovebit/lovebitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Lovebit-Qt notifications under Growl 1.3.
Increase required age of Lovebit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLovebit properly when installing Lovebit-Qt over it. (Windows)
