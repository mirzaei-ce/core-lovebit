Lovebit Core version 0.9.2.1 is now available from:

  https://lovebit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LBT to 0.01 LBT
...
- Fix "Start lovebit on system login"
