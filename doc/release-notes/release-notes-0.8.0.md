Lovebit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lovebit/files/Lovebit/lovebit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lovebit
...
New/changed settings (command-line or lovebit.conf file)
--------------------------------------------------------
