Lovebit Core version 0.10.3 is now available from:

  <https://lovebit.org/bin/lovebit-core-0.10.3/>
...
(see https://github.com/lovebit/lovebit/pull/6793, as well as the 0.11.0
