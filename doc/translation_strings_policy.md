...
This document provides guidelines for internationalization of the Lovebit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lovebit_en.ts` remains unchanged.
