...
unlocked to sign the Lovebit-Qt.app bundle.
...
allowing somebody to distribute a Lovebit-Qt.app or lovebit-qt-setup.exe with a valid
...
that the lovebit-qt.exe file inside the installer had not been tampered with.
