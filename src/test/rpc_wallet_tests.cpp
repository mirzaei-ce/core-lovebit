...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CLovebitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CLovebitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CLovebitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CLovebitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CLovebitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CLovebitAddress(arr[0].get_str()).Get() == demoAddress.Get());
