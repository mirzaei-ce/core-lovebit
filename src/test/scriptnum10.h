...
#ifndef LOVEBIT_TEST_SCRIPTNUM10_H
#define LOVEBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Lovebit Core 0.10.0, for cross-comparison.
 */
public:
