...
#if defined(NDEBUG)
# error "Lovebit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Lovebit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s LBT additional fees, %d delta bytes\n",
