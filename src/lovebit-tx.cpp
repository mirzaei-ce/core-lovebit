...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Lovebit Core lovebit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lovebit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lovebit transaction") + "\n" +
              "  lovebit-tx [options] -create [commands]   " + _("Create hex-encoded lovebit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lovebit transaction
