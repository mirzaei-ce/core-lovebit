...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/lovebit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Lovebit Core"),
     ...
     * override -datadir in the lovebit.conf file in the default data directory
     * (to be consistent with lovebitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
