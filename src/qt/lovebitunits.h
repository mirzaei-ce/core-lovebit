...
#ifndef LOVEBIT_QT_LOVEBITUNITS_H
#define LOVEBIT_QT_LOVEBITUNITS_H
...
/** Lovebit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LovebitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LovebitUnits(QObject *parent);

    /** Lovebit units.
      @note Source: https://en.lovebit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LBT,
...
typedef LovebitUnits::Unit LovebitUnit;

#endif // LOVEBIT_QT_LOVEBITUNITS_H
